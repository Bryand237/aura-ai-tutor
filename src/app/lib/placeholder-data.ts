...
export const documents: Document[] = [
  ...
  },
  {
    ...
    contenu_texte: 'Primitives usuelles, intégration par parties, changement de variable.',
    id_cours: 1,
  },
  {
    id_document: 3,
    ...
    contenu_texte: 'Travail, énergie cinétique, énergie potentielle, conservation.',
    id_cours: 2,
  },
];
...
export const propositions: Proposition[] = [
  { id_proposition: 1, texte: 'Une définition ε-δ.', est_correcte: true, id_question: 1 },
  { id_proposition: 2, texte: 'Une identité algébrique.', est_correcte: false, id_question: 1 },
  { id_proposition: 3, texte: 'Une dérivée.', est_correcte: false, id_question: 1 },

  { id_proposition: 4, texte: 'lim(f+g)=lim(f)+lim(g).', est_correcte: true, id_question: 2 },
  { id_proposition: 5, texte: 'lim(f+g)=lim(f)×lim(g).', est_correcte: false, id_question: 2 },
  { id_proposition: 6, texte: 'lim(f+g)=lim(f)-lim(g).', est_correcte: false, id_question: 2 },
];
